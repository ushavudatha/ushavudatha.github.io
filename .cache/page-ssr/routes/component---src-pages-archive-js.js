...
// EXTERNAL MODULE: external "/Users/ushavudatha/Documents/GitHub/ushavudatha.github.io/node_modules/react/index.js"
var index_js_ = __webpack_require__(2088);
...
const IconLoader=()=>/*#__PURE__*/index_js_default().createElement("svg",{id:"logo",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 100 100"},/*#__PURE__*/index_js_default().createElement("title",null,"Loader Logo"),/*#__PURE__*/index_js_default().createElement("g",null,/*#__PURE__*/index_js_default().createElement("g",{id:"B",transform:"translate(11.000000, 5.000000)"}),/*#__PURE__*/index_js_default().createElement("path",{stroke:"currentColor",strokeWidth:"5",strokeLinecap:"round",strokeLinejoin:"round",d:"M 50, 5 L 11, 27 L 11, 72 L 50, 95 L 89, 73 L 89, 28 z"})),/*#__PURE__*/index_js_default().createElement("text",{x:"30",y:"70",fill:"currentColor",fontSize:"55px",fontFamily:"Consolas"},"U"));/* harmony default export */ const loader = (IconLoader);
...
/* harmony default export */ const og = ("/static/og-868699b72f0a662362e037356337cbd9.png");
...
var CSSTransition = __webpack_require__(9670);
...
setTabFocus(tabFocus-1);}}};return/*#__PURE__*/index_js_default().createElement(jobs_StyledContainer,{id:"jobs",ref:revealContainer},/*#__PURE__*/index_js_default().createElement(styles/* Heading */.X6,null,"Where I've Worked"),/*#__PURE__*/index_js_default().createElement(StyledTabs,null,/*#__PURE__*/index_js_default().createElement(StyledTabList,{role:"tablist","aria-label":"Job tabs",onKeyDown:e=>onKeyPressed(e)},data&&data.map(({node},i)=>{const{company}=node.frontmatter;return/*#__PURE__*/index_js_default().createElement("li",{key:i},/*#__PURE__*/index_js_default().createElement(StyledTabButton,{isActive:activeTabId===i,onClick:()=>setActiveTabId(i),ref:el=>tabs.current[i]=el,id:`tab-${i}`,role:"tab","aria-selected":activeTabId===i?true:false,"aria-controls":`panel-${i}`,tabIndex:activeTabId===i?'0':'-1'},/*#__PURE__*/index_js_default().createElement("span",null,company)));}),/*#__PURE__*/index_js_default().createElement(StyledHighlight,{activeTabId:activeTabId})),data&&data.map(({node},i)=>{const{frontmatter,html}=node;const{title,url,company,range}=frontmatter;return/*#__PURE__*/index_js_default().createElement(StyledTabContent,{key:i,isActive:activeTabId===i,id:`panel-${i}`,role:"tabpanel","aria-labelledby":`tab-${i}`,tabIndex:activeTabId===i?'0':'-1',hidden:activeTabId!==i},/*#__PURE__*/index_js_default().createElement(StyledJobTitle,null,/*#__PURE__*/index_js_default().createElement("span",null,title),/*#__PURE__*/index_js_default().createElement(StyledCompany,null,/*#__PURE__*/index_js_default().createElement("span",null,"\xA0@\xA0"),/*#__PURE__*/index_js_default().createElement("a",{href:url,target:"_blank",rel:"nofollow noopener noreferrer"},company))),/*#__PURE__*/index_js_default().createElement(StyledJobDetails,null,/*#__PURE__*/index_js_default().createElement("span",null,range)),/*#__PURE__*/index_js_default().createElement("div",{dangerouslySetInnerHTML:{__html:html}}));})));};Jobs.propTypes={data:(prop_types_default()).array.isRequired};/* harmony default export */ const jobs = (Jobs);
;// CONCATENATED MODULE: ./src/components/sections/featured.js
const{colors: featured_colors,fontSizes: featured_fontSizes,fonts: featured_fonts}=styles.theme;const featured_StyledContainer=(0,styled_components_esm["default"])(styles/* Section */.$0).withConfig({displayName:"featured__StyledContainer",componentId:"sc-19vdtah-0"})(["",";flex-direction:column;align-items:flex-start;"],styles/* mixins */.tA.flexCenter);const featured_StyledContent=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledContent",componentId:"sc-19vdtah-1"})(["position:relative;grid-column:1 / 7;grid-row:1 / -1;",";",";"],styles/* media */.BC.thone`
    grid-column: 1 / -1;
    padding: 40px 40px 30px;
    z-index: 5;
  `,styles/* media */.BC.phablet`padding: 30px 25px 20px;`);const StyledLabel=styled_components_esm["default"].h4.withConfig({displayName:"featured__StyledLabel",componentId:"sc-19vdtah-2"})(["font-size:",";font-weight:normal;color:",";font-family:",";margin-top:10px;padding-top:0;"],featured_fontSizes.smish,featured_colors.green,featured_fonts.SFMono);const StyledProjectName=styled_components_esm["default"].h5.withConfig({displayName:"featured__StyledProjectName",componentId:"sc-19vdtah-3"})(["font-size:28px;margin:0 0 20px;color:",";",";",";a{",";}"],featured_colors.lightestSlate,styles/* media */.BC.tablet`font-size: 24px;`,styles/* media */.BC.thone`color: ${featured_colors.lightestSlate};`,styles/* media */.BC.tablet`display: block;`);const featured_StyledDescription=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledDescription",componentId:"sc-19vdtah-4"})(["",";position:relative;z-index:2;padding:25px;background-color:",";color:",";font-size:",";border-radius:",";",";p{margin:0;}a{",";}"],styles/* mixins */.tA.boxShadow,featured_colors.lightNavy,featured_colors.lightSlate,featured_fontSizes.lg,styles.theme.borderRadius,styles/* media */.BC.thone`
  ...
  `,styles/* mixins */.tA.inlineLink);const StyledTechList=styled_components_esm["default"].ul.withConfig({displayName:"featured__StyledTechList",componentId:"sc-19vdtah-5"})(["position:relative;z-index:2;display:flex;flex-wrap:wrap;padding:0;margin:25px 0 10px;list-style:none;li{font-family:",";font-size:",";color:",";margin-right:",";margin-bottom:7px;white-space:nowrap;&:last-of-type{margin-right:0;}",";}"],featured_fonts.SFMono,featured_fontSizes.smish,featured_colors.green,styles.theme.margin,styles/* media */.BC.thone`
      color: ${featured_colors.green};
      margin-right: 10px;
    `);const featured_StyledLinkWrapper=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledLinkWrapper",componentId:"sc-19vdtah-6"})(["display:flex;align-items:center;position:relative;margin-top:10px;margin-left:-10px;color:",";a{padding:10px;svg{width:22px;height:22px;}}"],featured_colors.lightestSlate);const StyledFeaturedImg=(0,styled_components_esm["default"])(gatsby_image/* default */.Z).withConfig({displayName:"featured__StyledFeaturedImg",componentId:"sc-19vdtah-7"})(["width:100%;max-width:100%;height:80%;vertical-align:middle;border-radius:",";position:relative;mix-blend-mode:multiply;filter:hue-rotate(90deg);",";"],styles.theme.borderRadius,styles/* media */.BC.tablet`
    object-fit: cover;
    width: auto;
    height: 90%;
    filter: hue-rotate(90deg);
  `);const StyledImgContainer=styled_components_esm["default"].a.withConfig({displayName:"featured__StyledImgContainer",componentId:"sc-19vdtah-8"})(["",";grid-column:7 / -1;grid-row:1 / -1;position:relative;z-index:1;background-color:None;border-radius:","px;transition:",";",";",";&:hover,&:focus{background:transparent;&:before,","{background:transparent;filter:none;}}&:before{content:'';position:absolute;width:100%;height:100%;top:0;left:0;right:0;bottom:0;z-index:3;transition:",";mix-blend-mode:multiply;}"],styles/* mixins */.tA.boxShadow,styles.theme.radius+1,styles.theme.transition,styles/* media */.BC.tablet`height: 90%;`,styles/* media */.BC.thone`
    grid-column: 1 / -1;
    opacity: 0.25;
  `,StyledFeaturedImg,styles.theme.transition);const StyledProject=styled_components_esm["default"].div.withConfig({displayName:"featured__StyledProject",componentId:"sc-19vdtah-9"})(["display:grid;grid-gap:10px;grid-template-columns:repeat(12,1fr);align-items:center;margin-bottom:100px;",";&:last-of-type{margin-bottom:0;}&:nth-of-type(odd){","{grid-column:8 / -1;text-align:right;",";",";}","{justify-content:flex-end;li{margin-left:",";margin-right:0;}}","{justify-content:flex-end;margin-left:0;margin-right:-10px;}","{grid-column:1 / 8;",";",";}}"],styles/* media */.BC.thone`
    margin-bottom: 70px;
  `,featured_StyledContent,styles/* media */.BC.thone`
        grid-column: 1 / -1;
        padding: 40px 40px 30px;
      `,styles/* media */.BC.phablet`padding: 30px 25px 20px;`,StyledTechList,styles.theme.margin,featured_StyledLinkWrapper,StyledImgContainer,styles/* media */.BC.tablet`height: 100%;`,styles/* media */.BC.thone`
        grid-column: 1 / -1;
        opacity: 0.25;
      `);const Featured=({data})=>{const featuredProjects=data.filter(({node})=>node);const revealTitle=(0,index_js_.useRef)(null);const revealProjects=(0,index_js_.useRef)([]);(0,index_js_.useEffect)(()=>{sr/* default */.Z.reveal(revealTitle.current,(0,config.srConfig)());revealProjects.current.forEach((ref,i)=>sr/* default */.Z.reveal(ref,(0,config.srConfig)(i*100)));},[]);return/*#__PURE__*/index_js_default().createElement(featured_StyledContainer,{id:"projects"},/*#__PURE__*/index_js_default().createElement(styles/* Heading */.X6,{ref:revealTitle},"My Published Adventures"),/*#__PURE__*/index_js_default().createElement("div",null,featuredProjects&&featuredProjects.map(({node},i)=>{const{frontmatter,html}=node;const{external,title,tech,github,cover}=frontmatter;return/*#__PURE__*/index_js_default().createElement(StyledProject,{key:i,ref:el=>revealProjects.current[i]=el},/*#__PURE__*/index_js_default().createElement(featured_StyledContent,null,/*#__PURE__*/index_js_default().createElement(StyledLabel,null,"Featured Project"),/*#__PURE__*/index_js_default().createElement(StyledProjectName,null,external?/*#__PURE__*/index_js_default().createElement("a",{href:external,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":"External Link"},title):title),/*#__PURE__*/index_js_default().createElement(featured_StyledDescription,{dangerouslySetInnerHTML:{__html:html}}),tech&&/*#__PURE__*/index_js_default().createElement(StyledTechList,null,tech.map((tech,i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},tech))),/*#__PURE__*/index_js_default().createElement(featured_StyledLinkWrapper,null,github&&/*#__PURE__*/index_js_default().createElement("a",{href:github,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":"GitHub Link"},/*#__PURE__*/index_js_default().createElement(icons/* FormattedIcon */.SK,{name:"GitHub"})),external&&/*#__PURE__*/index_js_default().createElement("a",{href:external,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":"External Link"},/*#__PURE__*/index_js_default().createElement(icons/* FormattedIcon */.SK,{name:"External"})))),/*#__PURE__*/index_js_default().createElement(StyledImgContainer,{href:external?external:github?github:'#',target:"_blank",rel:"nofollow noopener noreferrer"},/*#__PURE__*/index_js_default().createElement(StyledFeaturedImg,{fluid:cover.childImageSharp.fluid,alt:title})));})));};Featured.propTypes={data:(prop_types_default()).array.isRequired};/* harmony default export */ const featured = (Featured);
;// CONCATENATED MODULE: ./src/components/sections/projects.js
const{colors: projects_colors,fontSizes: projects_fontSizes,fonts: projects_fonts}=styles.theme;const projects_StyledContainer=(0,styled_components_esm["default"])(styles/* Section */.$0).withConfig({displayName:"projects__StyledContainer",componentId:"sc-1tbcxji-0"})(["",";flex-direction:column;align-items:flex-start;"],styles/* mixins */.tA.flexCenter);const projects_StyledTitle=styled_components_esm["default"].h4.withConfig({displayName:"projects__StyledTitle",componentId:"sc-1tbcxji-1"})(["margin:0 auto;font-size:",";",";a{display:block;}"],projects_fontSizes.h3,styles/* media */.BC.tablet`font-size: 24px;`);const StyledArchiveLink=(0,styled_components_esm["default"])(gatsby_browser_entry.Link).withConfig({displayName:"projects__StyledArchiveLink",componentId:"sc-1tbcxji-2"})(["",";text-align:center;margin:0 auto;font-family:",";font-size:",";&:after{bottom:0.1em;}"],styles/* mixins */.tA.inlineLink,projects_fonts.SFMono,projects_fontSizes.sm);const StyledGrid=styled_components_esm["default"].div.withConfig({displayName:"projects__StyledGrid",componentId:"sc-1tbcxji-3"})(["margin-top:50px;margin-left:10%;.projects{display:grid;grid-template-columns:repeat(auto-fill,minmax(250px,1fr));grid-gap:5px;position:relative;",";}"],styles/* media */.BC.desktop`grid-template-columns: repeat(auto-fill, minmax(300px, 1fr));`);const StyledProjectInner=styled_components_esm["default"].div.withConfig({displayName:"projects__StyledProjectInner",componentId:"sc-1tbcxji-4"})(["",";",";flex-direction:column;align-items:flex-start;position:relative;padding:2rem 1.75rem;height:100%;border-radius:",";transition:",";background-color:",";"],styles/* mixins */.tA.boxShadow,styles/* mixins */.tA.flexBetween,styles.theme.borderRadius,styles.theme.transition,projects_colors.lightNavy);const projects_StyledProject=styled_components_esm["default"].div.withConfig({displayName:"projects__StyledProject",componentId:"sc-1tbcxji-5"})(["transition:",";cursor:default;&:hover,&:focus{outline:0;","{transform:translateY(-5px);}}"],styles.theme.transition,StyledProjectInner);const StyledProjectHeader=styled_components_esm["default"].div.withConfig({displayName:"projects__StyledProjectHeader",componentId:"sc-1tbcxji-6"})(["",";margin-bottom:30px;"],styles/* mixins */.tA.flexBetween);const StyledFolder=styled_components_esm["default"].div.withConfig({displayName:"projects__StyledFolder",componentId:"sc-1tbcxji-7"})(["color:",";svg{width:40px;height:40px;}"],projects_colors.green);const StyledProjectLinks=styled_components_esm["default"].div.withConfig({displayName:"projects__StyledProjectLinks",componentId:"sc-1tbcxji-8"})(["margin-right:-10px;color:",";"],projects_colors.lightSlate);const StyledIconLink=styled_components_esm["default"].a.withConfig({displayName:"projects__StyledIconLink",componentId:"sc-1tbcxji-9"})(["position:relative;top:-10px;padding:10px;svg{width:20px;height:20px;}"]);const projects_StyledProjectName=styled_components_esm["default"].h5.withConfig({displayName:"projects__StyledProjectName",componentId:"sc-1tbcxji-10"})(["margin:0 0 10px;font-size:",";color:",";"],projects_fontSizes.xxl,projects_colors.lightestSlate);const StyledProjectDescription=styled_components_esm["default"].div.withConfig({displayName:"projects__StyledProjectDescription",componentId:"sc-1tbcxji-11"})(["font-size:17px;color:",";a{",";}"],projects_colors.lightSlate,styles/* mixins */.tA.inlineLink);const projects_StyledTechList=styled_components_esm["default"].ul.withConfig({displayName:"projects__StyledTechList",componentId:"sc-1tbcxji-12"})(["display:flex;align-items:flex-end;flex-grow:1;flex-wrap:wrap;padding:0;margin:20px 0 0 0;list-style:none;li{font-family:",";font-size:",";color:",";line-height:1.75;margin-right:15px;&:last-of-type{margin-right:0;}}"],projects_fonts.SFMono,projects_fontSizes.xs,projects_colors.green);const StyledMoreButton=(0,styled_components_esm["default"])(styles/* Button */.zx).withConfig({displayName:"projects__StyledMoreButton",componentId:"sc-1tbcxji-13"})(["margin:100px auto 0;"]);const Projects=({data})=>{const{0:showMore,1:setShowMore}=(0,index_js_.useState)(false);const revealTitle=(0,index_js_.useRef)(null);const revealArchiveLink=(0,index_js_.useRef)(null);const revealProjects=(0,index_js_.useRef)([]);(0,index_js_.useEffect)(()=>{sr/* default */.Z.reveal(revealTitle.current,(0,config.srConfig)());sr/* default */.Z.reveal(revealArchiveLink.current,(0,config.srConfig)());revealProjects.current.forEach((ref,i)=>sr/* default */.Z.reveal(ref,(0,config.srConfig)(i*100)));},[]);const GRID_LIMIT=6;const projects=data.filter(({node})=>node);const firstSix=projects.slice(0,GRID_LIMIT);const projectsToShow=showMore?projects:firstSix;return/*#__PURE__*/index_js_default().createElement(projects_StyledContainer,null,/*#__PURE__*/index_js_default().createElement(projects_StyledTitle,{ref:revealTitle},"Other Noteworthy Projects"),/*#__PURE__*/index_js_default().createElement(StyledArchiveLink,{to:"/archive",ref:revealArchiveLink},"View Complete List of Projects/Codes"),/*#__PURE__*/index_js_default().createElement(StyledGrid,null,/*#__PURE__*/index_js_default().createElement(TransitionGroup/* default */.Z,{className:"projects"},projectsToShow&&projectsToShow.map(({node},i)=>{const{frontmatter,html}=node;const{github,external,title,tech}=frontmatter;return/*#__PURE__*/index_js_default().createElement(CSSTransition/* default */.Z,{key:i,classNames:"fadeup",timeout:i>=GRID_LIMIT?(i-GRID_LIMIT)*300:300,exit:false},/*#__PURE__*/index_js_default().createElement(projects_StyledProject,{key:i,ref:el=>revealProjects.current[i]=el,tabIndex:"0",style:{transitionDelay:`${i>=GRID_LIMIT?(i-GRID_LIMIT)*100:0}ms`}},/*#__PURE__*/index_js_default().createElement(StyledProjectInner,null,/*#__PURE__*/index_js_default().createElement("header",null,/*#__PURE__*/index_js_default().createElement(StyledProjectHeader,null,/*#__PURE__*/index_js_default().createElement(StyledFolder,null,/*#__PURE__*/index_js_default().createElement(icons/* FormattedIcon */.SK,{name:"Folder"})),/*#__PURE__*/index_js_default().createElement(StyledProjectLinks,null,github&&/*#__PURE__*/index_js_default().createElement(StyledIconLink,{href:github,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":"GitHub Link"},/*#__PURE__*/index_js_default().createElement(icons/* FormattedIcon */.SK,{name:"GitHub"})),external&&/*#__PURE__*/index_js_default().createElement(StyledIconLink,{href:external,target:"_blank",rel:"nofollow noopener noreferrer","aria-label":"External Link"},/*#__PURE__*/index_js_default().createElement(icons/* FormattedIcon */.SK,{name:"External"})))),/*#__PURE__*/index_js_default().createElement(projects_StyledProjectName,null,title),/*#__PURE__*/index_js_default().createElement(StyledProjectDescription,{dangerouslySetInnerHTML:{__html:html}})),/*#__PURE__*/index_js_default().createElement("footer",null,tech&&/*#__PURE__*/index_js_default().createElement(projects_StyledTechList,null,tech.map((tech,i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},tech)))))));}))));};Projects.propTypes={data:(prop_types_default()).array.isRequired};/* harmony default export */ const projects = (Projects);
...
module.exports={siteTitle:'Usha Vudatha | Software Developer',siteDescription:'Usha Vudatha hold a masters degree in computer science from stony brook university',siteKeywords:'Usha Vudatha, Usha, Vudatha, ushavudatha, software developer, software engineer, Sentiment analysis, Competitive Programmer, web developer, python developer, Sperry Technologies, Stony Brook, New York, ',siteUrl:'https://ushavudatha.github.io/',siteLanguage:'en_US',googleAnalyticsID:'UA-45666519-2',googleVerification:'DCl7VAf9tcz6eD9gb67NfkNnJ1PKRNcg8qQiwpbx9Lk',name:'Usha Vudatha',location:'Stony Brook, New York',email:'ushavudatha@gmail.com',github:'https://github.com/ushavudatha',socialMedia:[{name:'GitHub',url:'https://github.com/ushavudatha'},{name:'Linkedin',url:'https://www.linkedin.com/in/usha-vudatha/'},{name:'Instagram',url:'https://www.instagram.com/usha_v17'}],navLinks:[{name:'About',url:'/#about'},{name:'Experience',url:'/#jobs'},{name:'Projects',url:'/#projects'},{name:'Contact',url:'/#contact'}],navHeight:100,colors:{green:'#D76E00',navy:'#f2ead3',darkNavy:'#ece1bf'},srConfig:(delay=200)=>({origin:'bottom',distance:'20px',duration:500,delay,rotate:{x:0,y:0,z:0},opacity:0,scale:1,easing:'cubic-bezier(0.645, 0.045, 0.355, 1)',mobile:true,reset:false,useDelay:'always',viewFactor:0.25,viewOffset:{top:0,right:0,bottom:0,left:0}})};
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2088);
...
/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6872);
...
const Section=styled_components_esm["default"].section.withConfig({displayName:"Section",componentId:"sc-11s1stw-0"})(["margin:0 auto;padding:150px 0;max-width:1000px;",";"],styles_media.tablet`padding: 100px 0;`);/* harmony default export */ const styles_Section = (Section);
...
*/
var aa=__webpack_require__(2088),m=__webpack_require__(4852),r=__webpack_require__(3840);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
